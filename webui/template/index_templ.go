...
func Index() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<div><form id=\"searchForm\"><input type=\"text\" id=\"objectId\" name=\"objectId\" placeholder=\"Object ID (e.g., ark:abc/123)\" class=\"\" required> <button type=\"submit\">Find Object</button></form></div><script>\n\t\t\tdocument.getElementById('searchForm').addEventListener('submit', function(e) {\n\t\t\t\te.preventDefault();\n\t\t\t\tconst objectId = document.getElementById('objectId').value;\n\t\t\t\tconst encodedId = encodeURIComponent(objectId);\n\t\t\t\twindow.location.href = `/object/${encodedId}/head/`;\n\t\t\t});\n\t\t</script>")
			if templ_7745c5c3_Err != nil {
